...
class MorePizza(private val name: String, private val fileIn: File, private val fileOut: File) : Runnable {
    override fun run() {
        try {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            for (arg in args) {
                ...
                val slices = MorePizza(filename, fileIn, fileOut)
                Thread(slices).start()
            }
        }
    }
